...
// });
    ...
    Route::group(['middleware' => 'auth'],function() {
        ...
        Route::get('/owner/user_detail/{id}',[DisplayController::class,'userDetail'])->name('user.detail');
        Route::get('/owner/goods_detail/{id}',[DisplayController::class,'goodsDetail'])->name('goods.detail');
